...
If the user needs deeper context, offer LEVEL 2.
...
Local AI memory (Claude Code, IDE context, etc.) is a convenience cache only —
it is lost when switching machines. The git memory-bank has everything.
